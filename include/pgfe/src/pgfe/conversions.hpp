...
struct Generic_data_conversions final
{
	...
	{
		return StringConversions::to_type(std::string{static_cast<const char*>(data.bytes()), data.size()}, std::forward<Types>(args)...);
	}
...
template <>
struct Numeric_string_conversions<short int> final: private Numeric_string_conversions_base<int>
{
	...
	static Type to_type(const std::string& text, Types&&...)
	{
		...
		if (result > max)
			throw Client_exception{
				 "cannot convert to type: numeric value " + std::to_string(result) + " is greater than " + std::to_string(max)};
...
template <>
struct Numeric_string_conversions<int> final: private Numeric_string_conversions_base<int>
{
	using Type = int;
	using Numeric_string_conversions_base::to_string;
...
template <>
struct Numeric_string_conversions<long int> final: private Numeric_string_conversions_base<long int>
{
	using Type = long int;
	using Numeric_string_conversions_base::to_string;
...
template <>
struct Numeric_string_conversions<long long int> final: private Numeric_string_conversions_base<long long int>
{
...
template <>
struct Numeric_string_conversions<float> final: private Numeric_string_conversions_base<float>
{
	using Type = float;
	using Numeric_string_conversions_base::to_string;
...
template <>
struct Numeric_string_conversions<double> final: private Numeric_string_conversions_base<double>
{
	using Type = double;
	using Numeric_string_conversions_base::to_string;
...
template <>
struct Numeric_string_conversions<long double> final: private Numeric_string_conversions_base<long double>
{
...
private:
	...
	static Type to_type__(const char* const text, const std::size_t size)
	{
		...
		else if (std::strncmp(text, "t", size) == 0 || std::strncmp(text, "true", size) == 0 || std::strncmp(text, "TRUE", size) == 0
				 || std::strncmp(text, "y", size) == 0 || std::strncmp(text, "yes", size) == 0 || std::strncmp(text, "on", size) == 0
				 || std::strncmp(text, "1", size) == 0)
			return true;
		else if (std::strncmp(text, "f", size) == 0 || std::strncmp(text, "false", size) == 0 || std::strncmp(text, "FALSE", size) == 0
				 || std::strncmp(text, "n", size) == 0 || std::strncmp(text, "no", size) == 0 || std::strncmp(text, "off", size) == 0
 ...
 */
template <typename T>
struct Numeric_conversions: Basic_conversions<T, detail::Numeric_string_conversions<T>, detail::Numeric_data_conversions<T>>
{};
 ...
 */
template <>
struct Conversions<Row>
{
	static Row&& to_type(Row&& row) noexcept { return std::move(row); }
};
 ...
 */
template <typename T>
struct Conversions final: Basic_conversions<T, detail::Generic_string_conversions<T>, detail::Generic_data_conversions<T>>
{
 ...
 */
template <>
struct Conversions<std::string> final: Basic_conversions<std::string,
											detail::Forwarding_string_conversions,
											detail::Generic_data_conversions<std::string, detail::Forwarding_string_conversions>>
{};
...
struct Conversions<std::string_view> final
 : Basic_conversions<std::string_view, detail::Forwarding_string_conversions, detail::String_view_data_conversions>
{};
 ...
 */
template <>
struct Conversions<char> final: Basic_conversions<char, detail::Char_string_conversions, detail::Char_data_conversions>
{};
 ...
 */
template <>
struct Conversions<bool> final: Basic_conversions<bool, detail::Bool_string_conversions, detail::Bool_data_conversions>
{};
