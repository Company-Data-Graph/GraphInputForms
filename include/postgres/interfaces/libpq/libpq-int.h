...
struct pg_conn
{
	 ...
	 */
	PQExpBufferData m_errorMessage; /* expansible string */
...
extern void pqSetResultError(PGresult* res, PQExpBuffer m_errorMessage);
...
extern void pqBuildErrorMessage3(PQExpBuffer msg, const PGresult* res, PGVerbosity verbosity, PGContextVisibility show_context);
...
extern char* libpq_ngettext(const char* msgid, const char* msgid_plural, unsigned long n) pg_attribute_format_arg(1)
